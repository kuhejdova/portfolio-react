  ...
  return (
    <Container maxW={"7xl"}>
      ...
      <SimpleGrid
        ...
        paddingTop={10}
      >
        <Link color="teal.500" href="https://semibold.vercel.app/">
          <Center>
            <HStack paddingTop={5} align={"center"}>
              <IconButton
                variant="outline"
                colorScheme="teal"
                aria-label="neardear application"
                fontSize="20px"
                icon={<BsGlobe />}
              />{" "}
              <Text>Generative application for Near & Dear </Text>
            </HStack>
          </Center>
        </Link>
        <Link
          ...
          <Center>
            <HStack paddingTop={5} align={"center"}>
              <IconButton
                ...
                icon={<BsGlobe />}
              />{" "}
              <Text>Visual identity created by Semibold </Text>
            </HStack>
          </Center>
        </Link>
      </SimpleGrid>
